...
class MongoCxxConan(ConanFile):
    ...
    def requirements(self):
        c_driver_version = "1.29.0" if Version(self.version) < "4.1" else "2.1.2"
    ...
    def generate(self):
        ...
        def c_driver_config_file(component):
            filename = f"{component}-1.0-config.cmake" if Version(self.dependencies["mongo-c-driver"].ref.version) <= 1 else f"{component}-config.cmake"
